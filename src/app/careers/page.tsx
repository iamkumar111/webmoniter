...
export async function generateMetadata(): Promise<Metadata> {
    return generatePageMetadata("careers", {
        title: "Careers - WebMoniter",
        description: "Join WebMoniter to build the future of website monitoring. We are hiring remote engineers, designers, and customer success leads.",
        keywords: ["webmoniter careers", "remote engineering jobs", "startup jobs", "site reliability engineer jobs"],
    });
}
                ...
                <section className="py-24 bg-gray-50">
                    <div className="container px-4 sm:px-6 lg:px-8 mx-auto max-w-5xl">
                        ...
                        <div className="mt-16 p-8 bg-white rounded-[2rem] border border-dashed border-gray-300 text-center shadow-sm">
                            ...
                            <Link href="mailto:careers@webmoniter.io" className="bg-indigo-600 text-white px-8 py-3 rounded-full font-bold hover:bg-indigo-700 transition-all inline-block">
