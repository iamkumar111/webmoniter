...
export async function generateMetadata(): Promise<Metadata> {
   return generatePageMetadata("contact", {
      title: "Contact Us - WebMoniter",
      description: "Get in touch with the WebMoniter team. We are here to help with your monitoring needs.",
      keywords: ["contact webmoniter", "support", "help center", "customer service"],
   });
}
                     ...
                     <div className="space-y-8">
                        <div className="flex items-start gap-4">
                           ...
                           <div>
                              ...
                              <a href="mailto:support@webmoniter.online" className="text-indigo-600 font-medium hover:underline mt-2 inline-block">support@webmoniter.online</a>
                           </div>
                        </div>
