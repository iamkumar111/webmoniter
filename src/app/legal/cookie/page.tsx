    ...
    <article className="prose prose-indigo max-w-none">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-700 leading-relaxed">
          WebMoniter uses cookies to improve your experience on our site. Cookies are small text files that are placed on your machine to help the site provide a better user experience. 
