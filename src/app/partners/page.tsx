...
export async function generateMetadata(): Promise<Metadata> {
    return generatePageMetadata("partners", {
        title: "Partner Program - WebsMoniter",
        description: "Join the WebsMoniter Partner Program. Earn revenue, get priority support, and access co-marketing opportunities.",
        keywords: ["websmoniter partners", "affiliate program", "reseller monitoring", "agency partnership"],
    });
}
    ...
    const benefits = [
        {
            title: "Revenue Share",
            icon: TrendingUp,
            description: "Earn a generous commission for every customer you refer to WebsMoniter.",
        },
        {
                    ...
                    <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div className="relative z-10">
                                ...
                                <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 mb-8 leading-[1.05] tracking-tight">Grow your business with WebsMoniter.</h1>
